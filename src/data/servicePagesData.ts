  ...
  'konstrukcje-stalowe': {
    ...
    cta: {
      PL: {
        ...
        description: 'Skontaktuj się z naszym Działem Handlowym. Przygotujemy profesjonalną wycenę, zweryfikujemy dokumentację warsztatową i zaplanujemy optymalny harmonogram montażu.',
        btnText: 'Wyślij zapytanie ofertowe',
        contactPerson: 'Dział Handlowy i Ofertowanie',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, wew. 137',
      },
      EN: {
        title: 'Planning a structural steel project?',
        description: 'Get in touch with our Commercial Department. We will review your fabrication drawings, provide a competitive quotation, and schedule on-site crane assembly.',
        btnText: 'Request a Quote',
        contactPerson: 'Commercial & Tendering Dept.',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, ext. 137',
      },
      DE: {
        title: 'Planen Sie ein Stahlbauprojekt?',
        description: 'Kontaktieren Sie unsere Vertriebsabteilung. Wir prüfen Ihre Ausführungspläne und erstellen ein detailliertes Angebot.',
        btnText: 'Angebot anfordern',
        contactPerson: 'Vertrieb & Angebotserstellung',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, Durchw. 137',
      },
      UA: {
        title: 'Плануєте виготовлення металоконструкцій?',
        description: 'Зв’яжіться з нашим комерційним відділом для розрахунку вартості, аналізу креслень КМД та погодження термінів монтажу.',
        btnText: 'Надіслати запит',
        contactPerson: 'Комерційний відділ та тендери',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, вн. 137',
      },
    },
  },
  ...
  'remonty-modernizacje-instalacji-przemyslowych': {
    ...
    technicalCapabilities: {
      PL: {
        ...
        specs: [
          { label: 'Doświadczenie w postojach', value: 'Wieloletnia praktyka w obsłudze planowych postojów remontowych' },
          { label: 'Mobilna obróbka skrawaniem', value: 'Planowanie przylg kołnierzowych o szerokim zakresie średnic, ukosowanie rurociągów' },
      ...
      EN: {
        ...
        specs: [
          { label: 'Turnaround Track Record', value: 'Extensive track record in industrial turnarounds' },
          { label: 'On-Site Field Machining', value: 'Flange facing across a wide diameter range, portable pipe cutting & beveling' },
      ...
      DE: {
        ...
        specs: [
          { label: 'Stillstandserfahrung', value: 'Langjährige Erfahrung bei geplanten Großstillständen' },
          { label: 'Vor-Ort-Bearbeitung', value: 'Mobiles Flanschendrehen für vielfältige Nennweiten, Rohranfasen' },
      ...
      UA: {
        ...
        specs: [
          { label: 'Досвід капітальних зупинок', value: 'Багаторічний практичний досвід супроводу планових зупинок' },
          { label: 'Мобільна механічна обробка', value: 'Проточка поверхонь фланців широкого діапазону діаметрів, зняття фасок' },
    ...
    cta: {
      PL: {
        ...
        contactPerson: 'Dział Handlowy i Realizacji',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, wew. 137',
      },
      EN: {
        ...
        contactPerson: 'Commercial & Maintenance Dept.',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, ext. 137',
      },
      DE: {
        ...
        contactPerson: 'Vertrieb & Industrieinstandhaltung',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, Durchw. 137',
      },
      UA: {
        ...
        contactPerson: 'Комерційний відділ та сервіс',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, вн. 137',
      },
    },
  ...
  'aparaty-cisnieniowe': {
    ...
    cta: {
      PL: {
        ...
        contactPerson: 'Dział Handlowy – Aparatura i Zbiorniki',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, wew. 137',
      },
      EN: {
        ...
        contactPerson: 'Commercial Dept. – Pressure Vessels',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, ext. 137',
      },
      DE: {
        ...
        contactPerson: 'Vertriebsabteilung Druckapparate',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, Durchw. 137',
      },
      UA: {
        ...
        contactPerson: 'Комерційний відділ – апарати та ємності',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, вн. 137',
      },
    },
  ...
  'montaz-urzadzen-przemyslowych': {
    ...
    cta: {
      PL: {
        ...
        description: 'Skontaktuj się z naszym Działem Handlowym. Zapewniamy kompletne ekipy monterskie, certyfikowany sprzęt dźwigowy i nadzór inżynierski.',
        btnText: 'Zapytaj o montaż urządzeń',
        contactPerson: 'Dział Handlowy i Realizacja Montaży',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, wew. 137',
      },
      EN: {
        title: 'Looking for a reliable mechanical installation contractor?',
        description: 'Contact our Commercial & Projects Team. We provide qualified mechanical crews, precision alignment tooling, and full engineering supervision.',
        btnText: 'Inquire About Installation',
        contactPerson: 'Commercial & Assembly Dept.',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, ext. 137',
      },
      DE: {
        title: 'Suchen Sie ein erfahrenes Industriemontage-Unternehmen?',
        description: 'Kontaktieren Sie unsere Vertriebsabteilung. Wir stellen qualifizierte Fachkräfte, Präzisionswerkzeuge und Bauleitung.',
        btnText: 'Industriemontage anfragen',
        contactPerson: 'Vertrieb & Industriemontage',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, Durchw. 137',
      },
      UA: {
        title: 'Шукаєте надійну монтажну компанію?',
        description: 'Зв’яжіться з нашим комерційним відділом для погодження монтажних бригад, техніки та графіків виконання робіт.',
        btnText: 'Замовити монтаж обладнання',
        contactPerson: 'Комерційний відділ та монтаж',
        email: 'dzialhandlowy@chemorozruch.pl',
        phone: '+48 33 842 59 20, вн. 137',
      },
    },
