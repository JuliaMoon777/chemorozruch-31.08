  ...
  PL: {
      ...
      items: [
        ...
        },
        {
          ...
          specs: [
            ...
            { label: 'Zakres średnic', value: 'Szeroki zakres średnic' },
    ...
    facilities: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Wielonawowy kompleks wytwórczy z suwnicami nadrzędnymi i wydzieloną nawą dla stali kwasoodpornych.',
      ...
      projects: [
        {
          ...
          details: {
            scope: 'Prefabrykacja i wymiana rurociągów procesowych, montaż armatury regulacyjnej, 100% badań NDT złączy spawanych.',
        ...
        },
        {
          ...
          details: {
            scope: 'Wytworzenie i montaż konstrukcji stalowych, montaż wiązek rurociągowych na estakadach.',
      ...
      branches: [
        {
          ...
          directionsUrl: 'https://www.google.com/maps/dir/?api=1&destination=Chemorozruch+ul.+Lipowa+5+32-600+Oswiecim',
          googleMapsUrl: 'https://maps.google.com/?q=CHEMOROZRUCH,+ul.+Lipowa+5,+32-600+Oświęcim',
          embedQuery: 'CHEMOROZRUCH+ul.+Lipowa+5,+32-600+Oświęcim',
        },
        {
          id: 'plock',
          city: 'Płock',
          ...
          directionsUrl: 'https://www.google.com/maps/dir/?api=1&destination=ul.+Witolda+Zglenickiego+50F+09-400+Plock',
          googleMapsUrl: 'https://maps.google.com/?q=CHEMOROZRUCH,+ul.+Witolda+Zglenickiego+50+F,+09-400+Płock',
    ...
    contactCTA: {
      ...
      directContact: {
        ...
        address: 'ul. Lipowa 5, 32-600 Oświęcim',
        phone: '+48 33 842 59 20',
        email: 'firma@chemorozruch.pl',
      },
    },
  ...
  EN: {
      ...
      items: [
        ...
        },
        {
          ...
          specs: [
            ...
            { label: 'Diameter Range', value: 'Broad nominal range' },
        ...
        },
        {
          ...
          specs: [
            ...
            { label: 'Shop Capacity', value: 'High production flexibility' },
    ...
    facilities: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Multi-bay manufacturing facility with heavy-duty overhead crane capacity and segregated stainless steel bay.',
          image: siteImages.zapleczeHall,
      ...
      projects: [
        {
          ...
          image: siteImages.realizacjaRafineria,
          details: {
            scope: 'Shop prefabrication and on-site replacement of process lines, control valve installation, 100% NDT inspection.',
        ...
        },
        {
          ...
          image: siteImages.realizacjaEstakada,
          details: {
            scope: 'Fabrication and erection of structural steelwork and installation of multi-pipe bundles at elevated heights.',
    ...
    footer: {
      ...
      columns: {
        ...
        hqLabel: 'Headquarters & Fabrication Facility',
        address: 'ul. Lipowa 5, 32-600 Oświęcim, Poland',
        phone: '+48 33 842 59 20',
        email: 'firma@chemorozruch.pl',
        navTitle: 'NAVIGATION',
        navLinks: {
  ...
  DE: {
      ...
      items: [
        ...
        },
        {
          ...
          specs: [
            ...
            { label: 'Nennweiten', value: 'Breites Nennweitenspektrum' },
        ...
        },
        {
          ...
          specs: [
            ...
            { label: 'Fertigungskapazität', value: 'Hohe Produktionsflexibilität' },
    ...
    facilities: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Überdachte Fertigungsfläche mit hoher Krankapazität und separatem Edelstahlbereich.',
          image: siteImages.zapleczeHall,
      ...
      projects: [
        {
          ...
          image: siteImages.realizacjaRafineria,
          details: {
            scope: 'Werkstattvorfertigung und Baustellenmontage von Prozessrohrleitungen, Regelarmaturen und umfassenden ZfP-Prüfungen.',
        ...
        },
        {
          ...
          image: siteImages.realizacjaEstakada,
          details: {
            scope: 'Fertigung und Montage von Stahlkonstruktionen sowie Verlegung von Rohrleitungspaketen in großer Höhe.',
    ...
    footer: {
      ...
      columns: {
        contactTitle: 'KONTAKT',
        hqLabel: 'Hauptsitz & Fertigungswerk',
        address: 'ul. Lipowa 5, 32-600 Oświęcim, Polen',
        phone: '+48 33 842 59 20',
        email: 'firma@chemorozruch.pl',
        navTitle: 'NAVIGATION',
        navLinks: {
  ...
  UA: {
        ...
        items: [
          {
            ...
            specs: [
              { label: 'Робочий тиск', value: 'Параметри згідно з проектом' },
          ...
          },
          {
            ...
            specs: [
              ...
              { label: 'Діапазон DN', value: 'Широкий діапазон діаметрів' },
          ...
          },
          {
            ...
            specs: [
              ...
              { label: 'Продуктивність', value: 'Висока виробнича гнучкість' },
      ...
      facilities: {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Виробничий комплекс з мостовими кранами високої вантажопідйомності та виділеною дільницею для нержавіючих сталей.',
            image: siteImages.zapleczeHall,
        ...
        projects: [
          {
            ...
            image: siteImages.realizacjaRafineria,
            details: {
              scope: 'Префабрикація та заміна технологічних трубопроводів, монтаж регулюючої арматури, 100% NDT контроль зварних з’єднань.',
          ...
          },
          {
            ...
            image: siteImages.realizacjaEstakada,
            details: {
              scope: 'Виготовлення та монтаж металоконструкцій, прокладання пакетів трубопроводів на проектній висоті.',
      ...
      footer: {
        ...
        columns: {
          ...
          hqLabel: 'Головний офіс та виробничий комплекс',
          address: 'ul. Lipowa 5, 32-600 Oświęcim, Польща',
          phone: '+48 33 842 59 20',
          email: 'firma@chemorozruch.pl',
          navTitle: 'НАВІГАЦІЯ',
          navLinks: {
